...
const PrivacyPolicyEnglish = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h2 className="text-xl">Interpretation and Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to KovancılarApp, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to KovancılarWeb.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to KovancılarWeb, accessible from{" "}
            <a
              href="https://kovancilar.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://kovancilar.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-xl">Collecting and Using Your Personal Data</h2>
      ...
      <h2 className="text-xl">Links to Other Websites</h2>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://kovancilar.vercel.app/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://kovancilar.vercel.app/contact
          </a>
        </li>
      </ul>
    </div>
